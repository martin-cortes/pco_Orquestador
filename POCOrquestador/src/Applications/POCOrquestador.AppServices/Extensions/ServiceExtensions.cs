...
using DrivenAdapters.Redis;
using Microsoft.Extensions.DependencyInjection;
using POCOrquestador.AppServices.Automapper;
using StackExchange.Redis;
using System;

namespace POCOrquestador.AppServices.Extensions
{
    /// <summary>
    /// Service Extensions
    /// </summary>
    public static class ServiceExtensions
    {
        ...
        public static IServiceCollection RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IAdapterCache, CloudCacheAdapter>();
